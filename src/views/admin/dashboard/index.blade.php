                    ...
                    <section class="col-lg-12 connectedSortable">
                        <div class="col-md-12 col-sm-12 col-12">
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    <div class="info-box">
                                        <span class="info-box-icon"><img src="" width="200"
                                                alt=""></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Selamat Datang di Sistem Informasi Keuangan
                                                Institusi Agama Islam Darullughah Wadda'wah,</span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <div class="input-group date">
                                                                <input type="input" name="tahun_akademik_1"
                                                                    class="form-control" id="tahun_akademik_1"
                                                                    style="cursor: pointer"
                                                                    placeholder="Masukkan Tahun Akademik" required>
                                                                <div class="input-group-append" id="tahun_akademik_1_btn"
                                                                    style="cursor: pointer">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="input-group date">
                                                                <input type="input" name="tahun_akademik_2"
                                                                    class="form-control" id="tahun_akademik_2"
                                                                    style="cursor: pointer"
                                                                    placeholder="Masukkan Tahun Akademik" required>
                                                                <div class="input-group-append" id="tahun_akademik_2_btn"
                                                                    style="cursor: pointer">
                                                                    <div class="input-group-text"><i
                                                                            class="fa fa-calendar"></i></div>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-4 mt-4 mt-sm-0">
                                                            <div class="form-group">
                                                                <select class="form-control select2bs4 w-100"
                                                                    name="semester_ta" id="semester_ta" required>
                                                                    <option value="">Pilih..</option>
                                                                    @foreach (BulkData::semester as $s)
                                                                        <option>{{ $s }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
