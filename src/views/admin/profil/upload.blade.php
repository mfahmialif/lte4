...
@section('title', auth()->user()->role . ' | Upload Foto Profil')
@section('css')
    {{-- Css CROP --}}
    <link rel="stylesheet" href="{{ asset('/admin/ijaboCropTool/ijaboCropTool.min.css') }}">
@endsection
@section('content')
                        ...
                        @if ($foto != null)
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle image-previewer"
                                    style="width: 200px!important;" src='{{ asset("/admin/foto/$foto") }}'
